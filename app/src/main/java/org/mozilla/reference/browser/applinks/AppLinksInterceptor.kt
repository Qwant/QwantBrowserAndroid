package org.mozilla.reference.browser.applinks
...
import org.mozilla.reference.browser.applinks.AppLinksUseCases.Companion.ENGINE_SUPPORTED_SCHEMES
    ...
    override fun onLoadRequest(
        ...
        if (redirect.isRedirect()) {
            if (launchFromInterceptor && result is RequestInterceptor.InterceptionResponse.AppIntent) {
                ...
                result.appIntent.flags = result.appIntent.flags or Intent.FLAG_GRANT_PERSISTABLE_URI_PERMISSION or Intent.FLAG_GRANT_READ_URI_PERMISSION
