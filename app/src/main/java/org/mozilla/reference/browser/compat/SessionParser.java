...
public abstract class SessionParser {
    private static final String LOGTAG = "QWANT_BROWSER";
        ...
        try {
            for (String sessionString : sessionStrings) {
                ...
                if (windowsArray.length() == 0) {
                    ...
                    Log.e(LOGTAG, "Session restore file is empty, no session entries found.");
                    continue;
                }
                ...
                for (int i = 0; i < tabs.length(); i++) {
                    ...
                    if (index < 1 || entries.length() < index) {
                        Log.e(LOGTAG, "Session entries and index don't agree.");
                        continue;
                    }
