...
public class Assist extends Activity {
    ...
    @Override protected void onCreate(Bundle savedInstanceState) {
        ...
        webview.getSettings().setUserAgentString("Mozilla/5.0 (Android 10; Mobile; rv:77.0) Gecko/77.0 Firefox/77.0 h QwantMobile/4.0");
    ...
    public void launch_search(String query) {
        ...
        if (query.length() > 0) {
            ...
            home_layout.setVisibility(View.INVISIBLE);
            webview.loadUrl(QwantUtils.Companion.getHomepage(getApplicationContext(), query, true, null, null, null, null, null, null));
            // Force hide keyboard
            InputMethodManager imm = (InputMethodManager) getSystemService(Activity.INPUT_METHOD_SERVICE);
