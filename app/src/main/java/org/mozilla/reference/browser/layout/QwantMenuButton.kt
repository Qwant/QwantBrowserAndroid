...
internal class QwantMenuButton @JvmOverloads constructor(
        context: Context,
    ...
    private val menuIcon =
            createImageView(R.drawable.ic_menu, context.getString(R.string.mozac_browser_toolbar_menu_button))
