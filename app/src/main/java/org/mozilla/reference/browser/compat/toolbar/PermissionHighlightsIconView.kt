...
// import mozilla.components.browser.toolbar.display.Update
...
internal class PermissionHighlightsIconView @JvmOverloads constructor(
    ...
    fun setIcons(icons: org.mozilla.reference.browser.compat.toolbar.DisplayToolbar.Icons.PermissionHighlights) {
